...
class XSLTExtension(object):
    ...
    def apply_templates(self, context, node, output_parent=None): # real signature unknown; restored from __doc__
        """
    ...
    def process_children(self, context, output_parent=None): # real signature unknown; restored from __doc__
        """
