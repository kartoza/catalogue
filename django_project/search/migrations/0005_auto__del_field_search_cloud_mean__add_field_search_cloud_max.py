...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Search.cloud_mean'
        db.delete_column(u'search_search', 'cloud_mean')

        # Adding field 'Search.cloud_max'
        db.add_column(u'search_search', 'cloud_max',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Search.cloud_mean'
        db.add_column(u'search_search', 'cloud_mean',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Search.cloud_max'
        db.delete_column(u'search_search', 'cloud_max')
    ...
    models = {
        ...
        u'search.search': {
            ...
            'band_count': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cloud_max': ('django.db.models.fields.IntegerField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'cloud_min': ('django.db.models.fields.IntegerField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
